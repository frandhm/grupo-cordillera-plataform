  ...
  return (
    <div className="kpi-card">
      <div className="kpi-card-top">
        ...
        <span className="kpi-status status-ok">
        ...
        {tab === 'crear-equipo' && (
          <section className="content-section" key="crear-equipo">
            ...
            <div className="create-layout">
              ...
              <div className="request-preview">
                <div className="preview-label">PREVIEW DEL REQUEST</div>
                <pre className="preview-code">{JSON.stringify({ method: 'POST', url: 'http://localhost:3000/api/dashboard/equipos', headers: { Authorization: 'Bearer <token>' }, body: { nombre: eqForm.nombre || '…', lider: eqForm.lider || '…', departamento: eqForm.departamento || '…', cantidadIntegrantes: eqForm.cantidadIntegrantes } }, null, 2)}</pre>
              </div>
            </div>
          </section>
        )}
